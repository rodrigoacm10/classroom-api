...
class ListSessionRosterUseCase:
    ...
    async def execute(self, data: ListSessionRosterInput) -> list[SessionRosterItem]:
        ...
        return await self.record_repo.list_session_roster(
